...
export interface PoolInterface {
    ...
    repayWithPermit: (args: LPRepayWithPermitParamsType) => Promise<EthereumTransactionTypeExtended[]>;
    ...
    paraswapRepayWithCollateral(args: LPParaswapRepayWithCollateral): Promise<EthereumTransactionTypeExtended[]>;
}
...
export declare class Pool extends BaseService<IPool> implements PoolInterface {
    ...
    liquidationCall({ liquidator, liquidatedUser, debtReserve, collateralReserve, purchaseAmount, getAToken, liquidateAll, useOptimizedPath, }: LPLiquidationCall): Promise<EthereumTransactionTypeExtended[]>;
    swapCollateral({ user, flash, fromAsset, fromAToken, toAsset, fromAmount, minToAmount, permitSignature, swapAll, referralCode, augustus, swapCallData, }: LPSwapCollateral): Promise<EthereumTransactionTypeExtended[]>;
    paraswapRepayWithCollateral({ user, fromAsset, fromAToken, assetToRepay, repayWithAmount, repayAmount, permitSignature, repayAllDebt, rateMode, referralCode, flash, swapAndRepayCallData, augustus, }: LPParaswapRepayWithCollateral): Promise<EthereumTransactionTypeExtended[]>;
    ...
    repayWithATokens({ user, amount, reserve, rateMode, useOptimizedPath, }: LPRepayWithATokensType): Promise<EthereumTransactionTypeExtended[]>;
