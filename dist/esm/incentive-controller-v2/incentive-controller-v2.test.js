...
describe('IncentiveController', () => {
    const correctProvider = new providers.JsonRpcProvider();
    jest
    ...
    describe('claimRewards', () => {
        ...
        it('Expects to get claimReward tx object with correct params', async () => {
            ...
            expect(claimRewardsTxObject[0].txType).toEqual(eEthereumTxType.REWARD_ACTION);
            ...
            // parse data
            const decoded = utils.defaultAbiCoder.decode(['address[]', 'uint256', 'address', 'address'], utils.hexDataSlice((_a = txObj.data) !== null && _a !== void 0 ? _a : '', 4));
    ...
    describe('claimAllRewards', () => {
        ...
        it('Expects to get claimAllReward tx object with correct params', async () => {
            ...
            expect(txObj.value).toEqual(DEFAULT_NULL_VALUE_ON_TX);
            // parse data
            const decoded = utils.defaultAbiCoder.decode(['address[]', 'address'], utils.hexDataSlice((_a = txObj.data) !== null && _a !== void 0 ? _a : '', 4));
            expect(decoded[0].length).toEqual(2);
            expect(decoded[0]).toEqual(assets);
