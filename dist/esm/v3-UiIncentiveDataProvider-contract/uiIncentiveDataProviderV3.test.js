    ...
    describe('getReservesIncentivesData', () => {
        ...
        it('should not throw', async () => {
            const spy = jest
                .spyOn(IUiIncentiveDataProviderV3__factory, 'connect')
                .mockReturnValue({
                getReservesIncentivesData: async () => Promise.resolve(getReservesIncentivesDataMock),
            });
    ...
    describe('getUserReserves', () => {
        ...
        it('should not throw if user is a valid ethereum address', async () => {
            const spy = jest
                .spyOn(IUiIncentiveDataProviderV3__factory, 'connect')
                .mockReturnValue({
                getUserReservesIncentivesData: async () => Promise.resolve(getUserIncentivesDataMock),
            });
