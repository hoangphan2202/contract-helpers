...
describe('StakingService', () => {
    ...
    describe('stakeWithPermit', () => {
        ...
        it('Expects the tx object when all params passed', async () => {
            ...
            const decoded = utils.defaultAbiCoder.decode(['address', 'uint256', 'uint8', 'bytes32', 'bytes32'], utils.hexDataSlice((_a = tx.data) !== null && _a !== void 0 ? _a : '', 4));
    ...
    describe('stake', () => {
        ...
        const { populateTransaction } = IStakedToken__factory.connect(TOKEN_STAKING_ADDRESS, provider);
        ...
        it('Expects the tx object when all params passed and no onBehalfOf with approval needed', async () => {
            ...
            expect(gasPrice).not.toBeNull();
            expect(gasPrice === null || gasPrice === void 0 ? void 0 : gasPrice.gasLimit).toEqual(gasLimitRecommendations[ProtocolAction.default].limit);
            expect(gasPrice === null || gasPrice === void 0 ? void 0 : gasPrice.gasPrice).toEqual('1');
        });
        it('Expects to fail when not initialized with TOKEN_STAKING_ADDRESS', async () => {
            const instance = new StakingService(provider, {
    ...
    describe('cooldown', () => {
        ...
        it('Expects the tx object when all params passed', async () => {
            ...
            expect(tx.from).toEqual(user);
            expect(tx.gasLimit).toEqual(BigNumber.from(1));
            const decoded = utils.defaultAbiCoder.decode([], utils.hexDataSlice((_a = tx.data) !== null && _a !== void 0 ? _a : '', 4));
