...
import { DEFAULT_NULL_VALUE_ON_TX, gasLimitRecommendations, } from '../commons/utils';
import { L2Encoder__factory } from './typechain/L2Encoder__factory';
import { L2Pool } from './index';
...
describe('L2Pool', () => {
    ...
    describe('Init L2Pool', () => {
        it('Expects to be initialized correctly', () => {
            const instance = new L2Pool(provider, config);
    ...
    describe('supply', () => {
        ...
        it('Expects tx object with optimized args', async () => {
            ...
            const decoded = utils.defaultAbiCoder.decode(['bytes32'], utils.hexDataSlice((_a = tx.data) !== null && _a !== void 0 ? _a : '', 4));
    ...
    describe('supplyWithPermit', () => {
        ...
        it('Expects tx object with optimized args', async () => {
            ...
            expect(tx.gasLimit).toEqual(BigNumber.from(1));
            expect(tx.value).toEqual(DEFAULT_NULL_VALUE_ON_TX);
            const decoded = utils.defaultAbiCoder.decode(['bytes32', 'bytes32', 'bytes32'], utils.hexDataSlice((_a = tx.data) !== null && _a !== void 0 ? _a : '', 4));
            expect(decoded[0]).toEqual(encodedArg);
    ...
    describe('liquidationCall', () => {
        ...
        it('Expects tx object with optimized args', async () => {
            ...
            expect(tx.gasLimit).toEqual(BigNumber.from(1));
            expect(tx.value).toEqual(DEFAULT_NULL_VALUE_ON_TX);
            const decoded = utils.defaultAbiCoder.decode(['bytes32', 'bytes32'], utils.hexDataSlice((_a = tx.data) !== null && _a !== void 0 ? _a : '', 4));
            expect(decoded[0]).toEqual(encodedArg);
