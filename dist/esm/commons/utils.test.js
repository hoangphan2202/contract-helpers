import { API_ETH_MOCK_ADDRESS, canBeEnsAddress, decimalsToCurrencyUnits, DEFAULT_NULL_VALUE_ON_TX, valueToWei, getTxValue, augustusToAmountOffsetFromCalldata, } from './utils';
describe('Utils', () => {
    describe('getTxValue', () => {
    ...
    describe('augustusToAmountOffsetFromCalldata', () => {
        ...
        it('Expects Error', () => {
            expect(() => augustusToAmountOffsetFromCalldata('asdf')).toThrowError(`Unrecognized function selector for Augustus`);
        });
    });
});
