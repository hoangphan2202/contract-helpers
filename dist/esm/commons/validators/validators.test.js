...
import { is0OrPositiveMetadataKey, isEthAddressArrayMetadataKey, isEthAddressArrayMetadataKeyNotEmpty, isEthAddressMetadataKey, isEthAddressOrENSMetadataKey, isPermitDeadline32Bytes, isPositiveMetadataKey, isPositiveOrMinusOneMetadataKey, } from './paramValidators';
import { amount0OrPositiveValidator, amountGtThan0OrMinus1, amountGtThan0Validator, isDeadline32BytesValidator, isEthAddressArrayValidator, isEthAddressArrayValidatorNotEmpty, isEthAddressOrEnsValidator, isEthAddressValidator, } from './validations';
...
describe('validators', () => {
    ...
    describe('isDeadline32BytesValidator', () => {
        ...
        it('Expects to run with no params', () => {
            ...
            Reflect.defineMetadata(isPermitDeadline32Bytes, undefined, target, propertyKey);
            expect(() => {
                isDeadline32BytesValidator(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        it('Expects to run with no deadline if optional', () => {
            ...
            Reflect.defineMetadata(isPermitDeadline32Bytes, existingPossibleAddresses, target, propertyKey);
            expect(() => {
                isDeadline32BytesValidator(target, propertyName, methodArguments, isParamOptional);
            }).not.toThrow();
        });
        it('Expect to not run with incorrect deadline', () => {
            ...
            expect(() => {
                isDeadline32BytesValidator(target, propertyName, methodArguments);
            }).toThrowError(`Deadline: ${methodArguments[0].deadline} is bigger than 32 bytes`);
        });
        it('Expect to not run with incorrect deadline and optional', () => {
            ...
            expect(() => {
                isDeadline32BytesValidator(target, propertyName, methodArguments, isParamOptional);
            }).toThrowError(`Deadline: ${constants.MaxUint256.toString()} is bigger than 32 bytes`);
        });
    ...
    describe('isEthAddressValidator', () => {
        ...
        it('Expects to run with no params', () => {
            ...
            Reflect.defineMetadata(isEthAddressMetadataKey, undefined, target, propertyKey);
            expect(() => {
                isEthAddressValidator(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        it('Expects to run with no address if optional', () => {
            ...
            Reflect.defineMetadata(isEthAddressMetadataKey, existingPossibleAddresses, target, propertyKey);
            expect(() => {
                isEthAddressValidator(target, propertyName, methodArguments, isParamOptional);
            }).not.toThrow();
        });
    ...
    describe('isEthAddressArrayValidatorNotEmpty', () => {
        it('Expects to run with correct address', () => {
            ...
            Reflect.defineMetadata(isEthAddressArrayMetadataKeyNotEmpty, existingPossibleAddresses, target, propertyKey);
            expect(() => {
                isEthAddressArrayValidatorNotEmpty(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        ...
        it('Expects to run with no params', () => {
            ...
            Reflect.defineMetadata(isEthAddressArrayMetadataKeyNotEmpty, undefined, target, propertyKey);
            expect(() => {
                isEthAddressArrayValidatorNotEmpty(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        it('Expects to run with no address if optional', () => {
            ...
            Reflect.defineMetadata(isEthAddressArrayMetadataKeyNotEmpty, existingPossibleAddresses, target, propertyKey);
            expect(() => {
                isEthAddressArrayValidatorNotEmpty(target, propertyName, methodArguments, isParamOptional);
            }).not.toThrow();
        });
        it('Expects to not run with incorrect address', () => {
            const methodArguments = {
    ...
    describe('isEthAddressArrayValidator', () => {
        ...
        it('Expects to run with no params', () => {
            ...
            Reflect.defineMetadata(isEthAddressArrayMetadataKey, undefined, target, propertyKey);
            expect(() => {
                isEthAddressArrayValidator(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        it('Expects to run with no address if optional', () => {
            ...
            Reflect.defineMetadata(isEthAddressArrayMetadataKey, existingPossibleAddresses, target, propertyKey);
            expect(() => {
                isEthAddressArrayValidator(target, propertyName, methodArguments, isParamOptional);
            }).not.toThrow();
        });
        it('Expects to not run with incorrect address', () => {
            const methodArguments = {
    ...
    describe('amountGtThan0Validator', () => {
        it('Expects to run if all params correct', () => {
            ...
            Reflect.defineMetadata(isPositiveMetadataKey, existingPossibleAddresses, target, propertyKey);
            expect(() => {
        ...
        it('Expects to run if no params and optional', () => {
            ...
            expect(() => {
                amountGtThan0Validator(target, propertyName, methodArguments, isOptional);
            }).not.toThrow();
        });
    ...
    describe('amountGtThan0OrMinus1', () => {
        it('Expects to run with all params correct', () => {
            ...
            Reflect.defineMetadata(isPositiveOrMinusOneMetadataKey, existingPossibleAddresses, target, propertyKey);
            expect(() => {
        ...
        it('Expects to run if all no params but optional', () => {
            ...
            const isOptional = [true];
            expect(() => {
                amountGtThan0OrMinus1(target, propertyName, methodArguments, isOptional);
            }).not.toThrow();
        });
    ...
    describe('amount0OrPositiveValidator', () => {
        it('Expects to run with all params correct', () => {
            ...
            Reflect.defineMetadata(is0OrPositiveMetadataKey, existingPossibleAddresses, target, propertyKey);
            expect(() => {
        ...
        it('Expects to run if no params but optional', () => {
            ...
            const isOptional = [true];
            expect(() => {
                amount0OrPositiveValidator(target, propertyName, methodArguments, isOptional);
            }).not.toThrow();
        });
        it('Expects to run if no params and no field but optional', () => {
            const methodArguments = {};
