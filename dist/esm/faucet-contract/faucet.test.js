...
import { DEFAULT_NULL_VALUE_ON_TX, mintAmountsPerToken, } from '../commons/utils';
...
describe('FaucetService', () => {
    ...
    describe('mint', () => {
        ...
        it('Expects the tx object if all params', async () => {
            ...
            // parse data
            const decoded = utils.defaultAbiCoder.decode(['address', 'uint256'], utils.hexDataSlice((_a = txObj.data) !== null && _a !== void 0 ? _a : '', 4));
            expect(decoded[0]).toEqual(reserve);
            expect(decoded[1]).toEqual(BigNumber.from(mintAmountsPerToken[tokenSymbol]));
            // gas price
