...
describe('IncentiveController', () => {
    ...
    describe('Create new IncentvieController', () => {
        it('Expects to be initialized correctly', () => {
            const incentivesInstance = new index_1.IncentivesControllerV2(correctProvider);
            expect(incentivesInstance instanceof index_1.IncentivesControllerV2);
        });
    });
    describe('claimRewards', () => {
        ...
        it('Expects to get claimReward tx object with correct params', async () => {
            ...
            // parse data
            const decoded = ethers_1.utils.defaultAbiCoder.decode(['address[]', 'uint256', 'address', 'address'], ethers_1.utils.hexDataSlice((_a = txObj.data) !== null && _a !== void 0 ? _a : '', 4));
        ...
        it('Expects to not get claimReward tx with wrong params: reward', () => {
            ...
            expect(() => incentivesInstance.claimRewards({
                ...
                incentivesControllerAddress,
                reward,
            })).toThrowError(new Error(`Address: ${reward} is not a valid ethereum Address`));
        });
    ...
    describe('claimAllRewards', () => {
        ...
        it('Expects to get claimAllReward tx object with correct params', async () => {
            var _a;
            const claimRewardsTxObject = incentivesInstance.claimAllRewards({
                user,
                assets,
                to,
                incentivesControllerAddress,
            ...
            expect(txObj.value).toEqual(utils_1.DEFAULT_NULL_VALUE_ON_TX);
            // parse data
            const decoded = ethers_1.utils.defaultAbiCoder.decode(['address[]', 'address'], ethers_1.utils.hexDataSlice((_a = txObj.data) !== null && _a !== void 0 ? _a : '', 4));
            expect(decoded[0].length).toEqual(2);
            expect(decoded[0]).toEqual(assets);
        ...
        it('Expects to not get claimAllReward tx with wrong params: user', () => {
            const user = 'asdf';
            expect(() => incentivesInstance.claimAllRewards({
                user,
                assets,
                to,
                incentivesControllerAddress,
...
//# sourceMappingURL=incentive-controller-v2.test.js.map