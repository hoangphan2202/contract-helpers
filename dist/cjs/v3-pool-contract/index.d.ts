...
export declare class Pool extends BaseService<IPool> implements PoolInterface {
    ...
    paraswapRepayWithCollateral({ user, fromAsset, fromAToken, assetToRepay, repayWithAmount, repayAmount, permitSignature, repayAllDebt, rateMode, onBehalfOf, referralCode, flash, swapAndRepayCallData, augustus, }: LPParaswapRepayWithCollateral): Promise<EthereumTransactionTypeExtended[]>;
