...
describe('GovernancePowerDelegationService', () => {
    ...
    const { populateTransaction } = IGovernancePowerDelegationToken__factory_1.IGovernancePowerDelegationToken__factory.connect(GOVERNANCE_TOKEN, provider);
    const service = new index_1.GovernancePowerDelegationTokenService(provider);
    jest
        .spyOn(IGovernancePowerDelegationToken__factory_1.IGovernancePowerDelegationToken__factory, 'connect')
        .mockReturnValue({
        populateTransaction,
    ...
    describe('delegate', () => {
        ...
        it('should error on invalid ens', async () => {
            await expect(async () => service.delegate({
                user,
                governanceToken: GOVERNANCE_TOKEN,
                delegatee: 'bla.eth',
        ...
        it('should error on malformed ens', async () => {
            await expect(async () => service.delegate({
                ...
                governanceToken: GOVERNANCE_TOKEN,
                delegatee: 'aave',
            })).rejects.toThrowError(`Address aave is not valid ENS format or a valid ethereum Addres`);
        });
    });
...
//# sourceMappingURL=governance-power-delegation-contract.test.js.map