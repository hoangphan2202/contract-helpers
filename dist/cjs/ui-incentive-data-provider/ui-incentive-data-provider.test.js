...
describe('UiIncentiveDataProvider', () => {
    ...
    const createValidInstance = () => {
        ...
        mockGetReservesIncentivesData.mockResolvedValue(_mocks_1.getReservesIncentivesDataMock);
        mockGetUserIncentivesData.mockResolvedValue(_mocks_1.getUserIncentivesDataMock);
