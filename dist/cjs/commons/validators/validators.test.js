...
describe('validators', () => {
    ...
    describe('isDeadline32BytesValidator', () => {
        it('Expects to run with correct deadline', () => {
            ...
            Reflect.defineMetadata(paramValidators_1.isPermitDeadline32Bytes, existingPossibleAddresses, target, propertyKey);
            expect(() => {
                (0, validations_1.isDeadline32BytesValidator)(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        ...
        it('Expects to run with no params', () => {
            ...
            Reflect.defineMetadata(paramValidators_1.isPermitDeadline32Bytes, undefined, target, propertyKey);
            expect(() => {
                (0, validations_1.isDeadline32BytesValidator)(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        it('Expects to run with no deadline if optional', () => {
            ...
            Reflect.defineMetadata(paramValidators_1.isPermitDeadline32Bytes, existingPossibleAddresses, target, propertyKey);
            expect(() => {
                (0, validations_1.isDeadline32BytesValidator)(target, propertyName, methodArguments, isParamOptional);
            }).not.toThrow();
        });
        ...
        it('Expect to not run with incorrect deadline and optional', () => {
            const methodArguments = {
                '0': ethers_1.constants.MaxUint256.toString(),
            };
            const existingPossibleAddresses = [
                {
                    index: 0,
            ...
            expect(() => {
                (0, validations_1.isDeadline32BytesValidator)(target, propertyName, methodArguments, isParamOptional);
            }).toThrowError(`Deadline: ${ethers_1.constants.MaxUint256.toString()} is bigger than 32 bytes`);
        });
    ...
    describe('isEthAddressValidator', () => {
        it('Expects to run with correct address', () => {
            ...
            expect(() => {
                (0, validations_1.isEthAddressValidator)(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        ...
        it('Expects to run with no address if optional', () => {
            ...
            Reflect.defineMetadata(paramValidators_1.isEthAddressMetadataKey, existingPossibleAddresses, target, propertyKey);
            expect(() => {
                (0, validations_1.isEthAddressValidator)(target, propertyName, methodArguments, isParamOptional);
            }).not.toThrow();
        });
    ...
    describe('isEthAddressArrayValidatorNotEmpty', () => {
        it('Expects to run with correct address', () => {
            ...
            expect(() => {
                (0, validations_1.isEthAddressArrayValidatorNotEmpty)(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        ...
        it('Expects to run with no address if optional', () => {
            ...
            Reflect.defineMetadata(paramValidators_1.isEthAddressArrayMetadataKeyNotEmpty, existingPossibleAddresses, target, propertyKey);
            expect(() => {
                (0, validations_1.isEthAddressArrayValidatorNotEmpty)(target, propertyName, methodArguments, isParamOptional);
            }).not.toThrow();
        });
        it('Expects to not run with incorrect address', () => {
            const methodArguments = {
    ...
    describe('isEthAddressArrayValidator', () => {
        it('Expects to run with correct address', () => {
            ...
            expect(() => {
                (0, validations_1.isEthAddressArrayValidator)(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        ...
        it('Expects to run with no address if optional', () => {
            ...
            Reflect.defineMetadata(paramValidators_1.isEthAddressArrayMetadataKey, existingPossibleAddresses, target, propertyKey);
            expect(() => {
                (0, validations_1.isEthAddressArrayValidator)(target, propertyName, methodArguments, isParamOptional);
            }).not.toThrow();
        });
        it('Expects to not run with incorrect address', () => {
            const methodArguments = {
    ...
    describe('isEthAddressOrEnsValidator', () => {
        it('should not throw for valid ens with isParaOptional omitted', () => {
            ...
            expect(() => {
                (0, validations_1.isEthAddressOrEnsValidator)(target, propertyName, methodArguments);
            }).not.toThrow();
        });
    ...
    describe('amountGtThan0Validator', () => {
        it('Expects to run if all params correct', () => {
            ...
            expect(() => {
                (0, validations_1.amountGtThan0Validator)(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        ...
        it('Expects to run if no params and optional', () => {
            ...
            expect(() => {
                (0, validations_1.amountGtThan0Validator)(target, propertyName, methodArguments, isOptional);
            }).not.toThrow();
        });
    ...
    describe('amountGtThan0OrMinus1', () => {
        it('Expects to run with all params correct', () => {
            ...
            expect(() => {
                (0, validations_1.amountGtThan0OrMinus1)(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        ...
        it('Expects to run if all no params but optional', () => {
            ...
            const isOptional = [true];
            expect(() => {
                (0, validations_1.amountGtThan0OrMinus1)(target, propertyName, methodArguments, isOptional);
            }).not.toThrow();
        });
    ...
    describe('amount0OrPositiveValidator', () => {
        it('Expects to run with all params correct', () => {
            ...
            expect(() => {
                (0, validations_1.amount0OrPositiveValidator)(target, propertyName, methodArguments);
            }).not.toThrow();
        });
        ...
        it('Expects to run if no params but optional', () => {
            ...
            const isOptional = [true];
            expect(() => {
                (0, validations_1.amount0OrPositiveValidator)(target, propertyName, methodArguments, isOptional);
            }).not.toThrow();
        });
        it('Expects to run if no params and no field but optional', () => {
            const methodArguments = {};
